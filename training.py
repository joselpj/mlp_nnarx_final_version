...
torch.save(mlp.state_dict(), SAVE_PATH + datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + ".dat")
print("Model saved to %s" % SAVE_PATH + datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + ".dat")
